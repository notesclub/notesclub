defmodule Notesclub.Notebooks.Notebook do
  ...
  @optional ~w(inserted_at user_id repo_id url content title search_vector ai_rating github_owner_id)a
  ...
  typed_schema "notebooks" do
    ...
    # The login can be renamed —and then taken by somebody else— so we also
    # store the account's immutable id. Deletions MUST match on this one.
    field(:github_owner_id, :integer)
