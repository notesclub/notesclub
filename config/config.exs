    ...
    plugins: [
      {Oban.Plugins.Cron,
       crontab: [
         ...
         {"0 9 * * *", Notesclub.Workers.BlueskyScheduledPostWorker, queue: :default},
         {"0 17 * * *", Notesclub.Workers.BlueskyScheduledPostWorker, queue: :default},
         {"0 10 * * *", Notesclub.Workers.XScheduledPostWorker, queue: :default},
         {"0 18 * * *", Notesclub.Workers.XScheduledPostWorker, queue: :default}
       ]},
